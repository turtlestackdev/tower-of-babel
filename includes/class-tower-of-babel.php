...
class Tower_Of_Babel {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Tower_Of_Babel_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'tower-of-babel';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Tower_Of_Babel_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Tower_Of_Babel_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Tower_Of_Babel_Loader    Orchestrates the hooks of the plugin.
	 */
